...
Condition: `cluster:kubevirt_virt_launcher_failed:count >= 200` appears for 10
minutes.
Virt-launcher Pods host virtual machine (VM) workloads and mass failures can
indicate
...
Ensure the failed count drops and stays below threshold and that new
virt-launcher
