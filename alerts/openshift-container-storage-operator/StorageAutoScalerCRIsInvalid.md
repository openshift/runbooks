...
- Duplicate CR detected: As a predefined rule for automatic storage scaling,
only one StorageAutoScaler CR should exist within a namespace. Presence of
multiple CRs results in this alert. The error message will appear as follows:
```bash
